...
Download the archive for your OS and extract at least the bin, lib, idl and
include directories to the gecko-sdk directory. For MacOS and Linux, you need 
to download the 64 bit version. 32 bit Linux is not supported.
